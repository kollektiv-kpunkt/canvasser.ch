...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-accent-40 text-left text-base font-medium text-accent bg-accent-50 focus:outline-none focus:text-accent-110 focus:bg-accent-10 focus:border-accent transition duration-150 ease-in-out'
